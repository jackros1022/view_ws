...
//    pcl_sub = nh.subscribe("/kinect2/sd/points", 1, &CloudHandler::cloudprocessCB, this);
    ...
    viewer2.setShowFPS(true);
    viewer2.setCameraPosition(0, 0, 0, 0, -1, 0);
  }
  ...
  void cloudprocessCB(const sensor_msgs::PointCloud2ConstPtr &cloud_input)
  {
    ...
    viewer2.removePointCloud("p_cloud2");
    viewer2.addPointCloud<pcl::PointXYZ>(cloud1.makeShared(), "p_cloud2");
...
{
  ros::init(argc, argv, "viewer_6dof2");
  ros::NodeHandle nh;
